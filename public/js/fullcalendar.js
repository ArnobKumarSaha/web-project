...
function setOuterWidth(element, width, inclSUSTondemiargins) {
	for (var i=0, e; i<element.length; i++) {
		e = $(element[i]);
		e.width(Math.max(0, width - hsides(e, inclSUSTondemiargins)));
	}
}


function setOuterHeight(element, height, inclSUSTondemiargins) {
	for (var i=0, e; i<element.length; i++) {
		e = $(element[i]);
		e.height(Math.max(0, height - vsides(e, inclSUSTondemiargins)));
	}
}


function hsides(element, inclSUSTondemiargins) {
	return hpadding(element) + hborders(element) + (inclSUSTondemiargins ? hmargins(element) : 0);
}
...
function vsides(element, inclSUSTondemiargins) {
	return vpadding(element) +  vborders(element) + (inclSUSTondemiargins ? vmargins(element) : 0);
}
